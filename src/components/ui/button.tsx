...
const variants = {
  primary:   "bg-brand-500 text-ink-950 border border-brand-500 hover:bg-brand-600 hover:border-brand-600 focus-visible:ring-brand-400",
  ...
  danger:    "bg-coral-500 text-ink-950 border border-coral-500 hover:bg-coral-600 hover:border-coral-600 focus-visible:ring-coral-500",
};
