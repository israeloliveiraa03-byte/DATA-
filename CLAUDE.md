...
- **Reskin ainda pendente** (fora do escopo da leva de 2026-06-30/2026-07-01, feito só no chrome global + login): páginas de conteúdo já existentes — dashboard, lista de pesquisas, form-builder, perfil, respondente (exceto header), territorio, landing page — ainda usam estilo inline com a paleta antiga (nem a azul de 2026-06-30 nem a argila atual chegaram lá). Migrar aos poucos, sem quebrar o que funciona. Sidebar/topbar/botões/cards que já usam os tokens (`brand-*`, `teal-*`) herdam a paleta argila automaticamente pela troca de tokens — não precisam de reskin manual de novo.
